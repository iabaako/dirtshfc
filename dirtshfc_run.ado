*! version 1.1.0 Ishmail Azindoo Baako (IPA) April 9, 2016
...
/* 
	...
	version 1.1.0: Removed all xlsx logging to dirts_enumdb.ado. This is to ensure that 
					* Even if looging to .xlsx crashes the smcl log files will have been created
